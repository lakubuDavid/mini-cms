...
export const env = createEnv({
  ...
  server: {
    ...
    UPSTASH_REDIS_KV_REST_API_TOKEN: z.string().min(1).optional(),
    UPSTASH_REDIS_KV_REST_API_URL: z.string().url().optional(),
    UPSTASH_REDIS_KV_REST_API_READ_ONLY_TOKEN: z.string().min(1).optional(),
